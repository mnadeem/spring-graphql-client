...
public class GraphQLResponse {
	...
	/*
	 * public String get(String path) { return get(path, String.class); }
	 * 
	 * public <T> T get(String path, Class<T> type) { return
	 * mapper.convertValue(context.read(path, Object.class), type); }
	 * 
	 * public <T> List<T> getList(String path, Class<T> type) { final List<?> raw =
	 * context.read(path, List.class); return mapper.convertValue(raw,
	 * mapper.getTypeFactory().constructCollectionType(List.class, type)); }
	 * 
	 * public ReadContext context() { return context; }
	 */
